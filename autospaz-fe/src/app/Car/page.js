...
function Content({ children }) {
  ...
  return (
    <>
      <NavBar>
        <AutoProvider>
          <nav class="font-sans flex flex-col text-center sm:flex-row sm:text-left sm:justify-between py-4 px-6 bg-white shadow sm:items-baseline w-full content-between">
            <button
            ...
            >
              <strong class="font-medium">Listado De Autos</strong>
              <svg
            ...
            <button
              ...
              class="group font-medium tracking-wide select-none text-base relative inline-flex items-center justify-center cursor-pointer h-12 border-2 border-solid py-0 px-6 rounded-md overflow-hidden z-10 transition-all duration-300 ease-in-out outline-0 bg-blue-500 text-white border-blue-500 hover:text-blue-500 focus:text-blue-500"
            >
              <strong class="font-medium">Nuevo Auto</strong>
              <svg
                class="ml-1 rotate-180 fill-white group-hover:fill-blue-500"
                width="27"
                height="27"
